...
const CreateBranchSnapshotSchema = z
  .object({
    branchId: z.string(),
...
const ParseFileVersionSchema = z
  .object({
    filePath: z.string(),
    contentHash: z.string(),
    content: z.string(),
...
const IndexFileVersionSchema = z
  .object({
    path: z.string(),
    contentHash: z.string(),
    content: z.string(),
