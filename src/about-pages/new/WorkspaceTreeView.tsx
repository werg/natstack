...
import { CaretRightIcon, CubeIcon, GearIcon, FileIcon } from "@radix-ui/react-icons";
...
function TreeNode({
  ...
  const getIcon = () => {
    if (node.launchable?.type === "worker") {
      return <GearIcon style={{ color: "var(--orange-9)", width: 14, height: 14 }} />;
    }
