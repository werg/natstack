 ...
 */
export type AboutPage = "model-provider-config" | "about" | "keyboard-shortcuts" | "help" | "new" | "adblock" | "agents" | "dirty-repo" | "git-init";

const VALID_ABOUT_PAGES: AboutPage[] = ["model-provider-config", "about", "keyboard-shortcuts", "help", "new", "adblock", "agents", "dirty-repo", "git-init"];
