 ...
 *
 * Wraps the existing @natstack/ai client to implement AiProvider interface.
...
/**
 * Create an RPC-based AI provider from the @natstack/ai client.
 *
  ...
  return {
    ...
    streamText(options: StreamTextOptions): StreamHandle {
      ...
      return {
        ...
        cancel() {
          cancelled = true;
          // The underlying @natstack/ai client doesn't have a direct cancel method
