/**
 * Context window usage tracking utilities.
 *
 * Provides a unified way to track token usage across different LLM provider
 * implementations (Claude Code, Codex, @natstack/ai). Workers use these utilities
 * to report context consumption via participant metadata updates.
 */
 ...
 * Workers convert their SDK-specific formats to this.
 */
...
export interface ContextTrackerOptions {
   ...
   * Workers should use this to update their participant metadata.
   *
   * @example
   * ```typescript
