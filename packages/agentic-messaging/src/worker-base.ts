 ...
 * Used by both agents (via @natstack/agent-patterns) and panels (via tool-ui).
 */

import { hasRichPreview } from "@natstack/agentic-protocol/tool-schemas";
import { normalizeToolName, getCanonicalToolName } from "@natstack/agentic-protocol/tool-name-utils";
...
// NOTE: showPermissionPrompt has been moved to @natstack/agent-patterns (agent-facing utility).
// Import from "@natstack/agent-patterns" instead.
