 ...
 *
 * Types and code generation are in @natstack/agentic-protocol.
 * This file provides TrackerClient-dependent utilities.
 */

import { CONTENT_TYPE_INLINE_UI } from "@natstack/agentic-protocol/content-types";
import { type InlineUiData, type TrackerClient } from "@natstack/agentic-protocol/tracker-types";
import { type TodoItem, getCachedTodoListCode } from "@natstack/agentic-protocol/todo-types";

export { type TodoItem, getTodoListCode, getCachedTodoListCode } from "@natstack/agentic-protocol/todo-types";
