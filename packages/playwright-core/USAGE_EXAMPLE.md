...
```typescript
import { BrowserImpl } from '@natstack/playwright-core';
...
```typescript
import { validateBrowserEnvironment } from '@natstack/playwright-core';
...
```typescript
import { TimeoutError } from '@natstack/playwright-core';
...
```typescript
import { BrowserImpl, validateBrowserEnvironment } from '@natstack/playwright-core';
...
### Before (Old API)
```typescript
import { CRBrowser } from '@natstack/playwright-core';
