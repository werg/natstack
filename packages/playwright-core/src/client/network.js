...
export class Request extends ChannelOwner {
    static from(request) {
...
export class Route extends ChannelOwner {
    static from(route) {
...
export class WebSocketRoute extends ChannelOwner {
    static from(route) {
        return route._object;
    }
    constructor(parent, type, guid, initializer) {
...
export class Response extends ChannelOwner {
...
export class WebSocket extends ChannelOwner {
