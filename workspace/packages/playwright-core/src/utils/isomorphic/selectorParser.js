...
export function splitSelectorByFrame(selectorText) {
...
export function stringifySelector(selector, forceEngineName) {
...
export function visitAllSelectorParts(selector, visitor) {
