...
export function locatorOrSelectorAsSelector(language, locator, testIdAttributeName) {
    try {
...
export function unsafeLocatorOrSelectorAsSelector(language, locator, testIdAttributeName) {
    try {
