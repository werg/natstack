...
export function asLocatorDescription(lang, selector) {
    try {
...
export function locatorCustomDescription(selector) {
    try {
        const parsed = parseSelector(selector);
...
export function asLocator(lang, selector, isFrameLocator = false) {
    return asLocators(lang, selector, isFrameLocator, 1)[0];
}
export function asLocators(lang, selector, isFrameLocator = false, maxOutputSize = 20, preferredQuote) {
    try {
...
export class JavaScriptLocatorFactory {
...
export class PythonLocatorFactory {
    generateLocator(base, kind, body, options = {}) {
        switch (kind) {
            case 'default':
                if (options.hasText !== undefined)
...
export class JavaLocatorFactory {
    generateLocator(base, kind, body, options = {}) {
        let clazz;
        switch (base) {
            case 'page':
...
export class CSharpLocatorFactory {
    generateLocator(base, kind, body, options = {}) {
        switch (kind) {
            case 'default':
                if (options.hasText !== undefined)
...
export class JsonlLocatorFactory {
    generateLocator(base, kind, body, options = {}) {
