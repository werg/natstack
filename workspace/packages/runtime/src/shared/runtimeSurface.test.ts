...
describe("runtimeSurface manifests", () => {
  ...
  it("matches the panel runtime export surface and wrapped namespaces", () => {
    ...
    expect(wrappedNamespaces).toEqual(new Set(["workers", "adblock", "workspace", "credentials", "git", "webhooks", "notifications", "gad"]));
  });
  ...
  it("matches the worker runtime interface, object shape, and wrapped namespaces", () => {
    ...
    expect(wrappedNamespaces).toEqual(new Set(["workers", "workspace", "credentials", "git", "webhooks", "notifications", "gad"]));
  });
