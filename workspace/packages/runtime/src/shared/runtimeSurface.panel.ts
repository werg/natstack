...
export const panelRuntimeSurface: RuntimeSurface = {
  ...
  exports: {
    ...
    pubsubConfig: valueEntry("PubSub HTTP gateway endpoint and token derived from the gateway config."),
    ...
    createUserlandApprovalAccessPolicy: valueEntry("Create an RPC access policy from an explicit RPC bridge."),
