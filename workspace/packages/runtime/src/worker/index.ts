...
export type { WorkspaceClient, WorkspaceConfig, WorkspaceEntry, WorkspaceUnitLogRecord, WorkspaceUnitStatus, WorkspaceUnitsClient, } from "../shared/workspace.js";
...
export function createWorkerRuntime(env: WorkerEnv): WorkerRuntime {
    ...
    const runtime: WorkerRuntime = {
        ...
        listCommits: (repoPath: string, ref?: string, limit?: number) => callMain<unknown[]>("git.listCommits", repoPath, ref, limit),
