/**
 * Panel-side notification client.
 *
 * Allows panels to push notifications to the shell chrome area
...
export function createNotificationClient(rpc: RpcBridge): NotificationClient {
  return {
    async show(opts) {
