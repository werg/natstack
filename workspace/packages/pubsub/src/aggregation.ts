/**
 * Replay event aggregation utilities.
 *
 * Provides aggregateReplayEvents for collecting raw replay events
 * into aggregated event structures during replay.
 */
...
// Re-export formatting utilities from missed-context
export {
  formatMissedContext,
